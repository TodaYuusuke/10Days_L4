...
namespace StateFactory::NormalBoss {
	...
	std::unordered_map<uint8_t, std::unique_ptr<IEnemyState>> CreateStates(const NormalBossData* data, NormalBossStateManager* sManeger, std::array<EnemyBullet, NormalBossData::kNormalBossBulletMax>* bullets);
}